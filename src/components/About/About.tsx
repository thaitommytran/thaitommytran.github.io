...
const About = () => {
  return (
    <section id="About" className="flex w-full flex-col items-center pt-[8rem]">
      {/* About Header */}
      ...
      <div className="flex flex-col items-center gap-6 py-8">
        ...
        <a
          className="mt-4 flex max-w-xs justify-center rounded-md bg-rose-500 px-10 py-3 text-white"
          target="_blank"
          rel="noreferrer"
